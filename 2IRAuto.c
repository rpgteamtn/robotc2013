...
task main()
{
  ...
  waitForStart(); // Wait for the beginning of autonomous phase.
	...
	reverse( 3530, 50, 100);
	runLift( 650, 100, -100); //move lift to free light
	straffrlight();

	switch (readIR()) {
		case	IR_RIGHT:
					straff(2450, TURN_RIGHT);
					forward( 2370, 50, 100);
					runLiftTimeClicks( 2150, 4500, 100, -100); //get lift in position
					break;
		case	IR_LEFT:
					straff(2350, TURN_LEFT);
					forward( 2470, 50, 100);
					runLiftTimeClicks( 2150, 4500, 100, -100); //get lift in position
					break;
		case	IR_STRAIGHT:
					straff(100, TURN_RIGHT);
					forward( 2370, 50, 100);
					runLiftTimeClicks( 2150, 4500, 100, -100); // lower lift for bottom rung
					break;
	}
